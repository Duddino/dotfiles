...
keys = [
    ...
    Key([], "XF86AudioLowerVolume", lazy.spawn("amixer -c 0 -D pulse set Master 10%- unmute")),
    Key([], "XF86AudioRaiseVolume", lazy.spawn("amixer -c 0 -D pulse sset Master 10%+ unmute")),
]
